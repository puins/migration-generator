...
namespace Puins\MigrateGenerator\Command;

use Puins\MigrateGenerator\Migration\LaravelMigrationForeignKeys;
use Puins\MigrateGenerator\Migration\ThinkphpMigrationForeignKeys;
use think\console\Command;
use think\console\Input;
use think\console\Output;
use Puins\MigrateGenerator\MigrateGenerator;
